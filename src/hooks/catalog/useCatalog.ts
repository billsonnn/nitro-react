...
const useCatalogState = () =>
{
    ...
    const [ purchasePreviewer, setPurchasePreviewer ] = useState<RoomPreviewer>(null)
    ...
    useEffect(() =>
    {
        ...
        setPurchasePreviewer(new RoomPreviewer(GetRoomEngine(), ++RoomPreviewer.PREVIEW_COUNTER))
        ...
        return () =>
        {
            ...
            setPurchasePreviewer(prevValue =>
            {
                prevValue.dispose()
    ...
    return { isVisible, setIsVisible, isBusy, pageId, previousPageId, currentType, rootNode, offersToNodes, currentPage, setCurrentPage, currentOffer, setCurrentOffer, activeNodes, searchResult, setSearchResult, frontPageItems, roomPreviewer, purchasePreviewer, navigationHidden, setNavigationHidden, purchaseOptions, setPurchaseOptions, catalogOptions, setCatalogOptions, getNodeById, getNodeByName, activateNode, openPageById, openPageByName, openPageByOfferId, requestOfferToMover }
}
