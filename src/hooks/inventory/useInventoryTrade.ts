...
import { CloneObject, GetRoomSession, GetSessionDataManager, GroupItem, LocalizeText, NotificationAlertType, SendMessageComposer, TradeState, TradeUserData, TradingNotificationType, parseTradeItems } from "../../api"
...
const useInventoryTradeState = () =>
{
    ...
    const progressTrade = () =>
    {
        ...
        case TradeState.TRADING_STATE_RUNNING:
            ...
            {
                simpleAlert(LocalizeText("inventory.trading.warning.other_not_offering"), NotificationAlertType.ALERT, null, null)
            }
