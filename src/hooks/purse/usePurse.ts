...
const usePurseState = () =>
{
    ...
    const helpAndSettingsDisabled = useMemo(() => GetConfiguration<boolean>("illumina.help_settings.disabled", false), [])
    ...
    return { purse, hcDisabled, helpAndSettingsDisabled, clubStatus, getCurrencyAmount }
}
