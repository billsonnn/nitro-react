...
export const ModToolsChatlogView: FC<ModToolsChatlogViewProps> = props =>
{
    ...
    return (
        <NitroCardView className="nitro-mod-tools-chatlog">
            <NitroCardSimpleHeaderView headerText={ 'Room Chatlog' + (roomName ? ': ' + roomName : '') } onCloseClick={ event => handleClick('close') } />
