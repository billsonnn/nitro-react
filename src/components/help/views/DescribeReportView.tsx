...
export const DescribeReportView: FC<{}> = props =>
{
    ...
    return (
        <>
            ...
            <textarea className="min-h-[calc(1.5em+ .5rem+2px)] px-[.5rem] py-[.25rem] text-[.7875rem] rounded-[.2rem] h-full" value={message} onChange={event => setMessage(event.target.value)} />
