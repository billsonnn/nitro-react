...
export const ToolbarView: FC<{ isInRoom: boolean }> = props =>
{
    ...
    return (
        <>
            ...
            <Flex alignItems="center" justifyContent="between" gap={2} className="absolute bottom-[0] left-[0] w-full h-[55px] bg-[rgba(28,_28,_32,_.95)] [box-shadow:inset_0_5px_#22222799,_inset_0_-4px_#12121599] py-1 px-3">
                <Flex gap={2} alignItems="center">
                    <Flex alignItems="center" gap={2}>
                        <Flex center pointer className={'relative w-[50px] h-[45px] overflow-hidden ' + (isMeExpanded ? 'active ' : '')} onClick={event => setMeExpanded(!isMeExpanded)}>
                            <LayoutAvatarImageView className='-ml-[5px] mt-[25px]' figure={userFigure} direction={2} position="absolute" />
                            {(getTotalUnseen > 0) &&
