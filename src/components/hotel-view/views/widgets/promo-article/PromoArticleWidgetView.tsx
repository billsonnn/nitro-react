...
export const PromoArticleWidgetView: FC<{}> = props =>
{
    ...
    return (
        <div className="promo-articles widget mb-2">
            <div className="flex flex-row items-center w-100 mb-1">
            ...
            <div className="flex flex-row mb-1">
                { articles && (articles.length > 0) && articles.map((article, ind) =>
                    <div key={ article.id } className={ 'promo-articles-bullet cursor-pointer ' + (article === articles[index] ? 'promo-articles-bullet-active' : '') } onClick={ event => setIndex(ind) } />
                ) }
            </div>
