...
export const HallOfFameItemView: FC<HallOfFameItemViewProps> = props =>
{
    ...
    return (
        <div className="group  h-full relative">
            <div className="invisible group-hover:visible absolute  w-[125px] max-w-[125px] p-[2px] bg-[#1c323f] border-[2px] border-[solid] border-[rgba(255,255,255,.5)] rounded-[.25rem] text-[.7875rem] z-40 -left-[15px] bottom-[calc(100%-10px)]">
