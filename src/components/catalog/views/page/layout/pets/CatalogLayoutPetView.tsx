                ...
                {currentOffer &&
                    <>
                        ...
                        <Column grow gap={1}>
                            ...
                            <Column grow gap={1}>
                                <input className="form-control form-control-sm w-full" placeholder={LocalizeText('widgets.petpackage.name.title')} type="text" value={petName} onChange={event => setPetName(event.target.value)} />
                                {(approvalResult > 0) &&
