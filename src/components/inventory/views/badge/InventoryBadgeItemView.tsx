...
export const InventoryBadgeItemView: FC<PropsWithChildren<{ badgeCode: string }>> = props =>
{
    ...
    return (
        <LayoutGridItem className="!h-12 !w-12" itemActive={ (selectedBadgeCode === badgeCode) } itemAbsolute={ true } itemUnseen={ unseen } onMouseDown={ event => setSelectedBadgeCode(badgeCode) } onDoubleClick={ event => toggleBadge(selectedBadgeCode) } { ...rest }>
