...
export const Button: FC<ButtonProps> = props =>
{
    ...
    {               // fucked up method i know (i dont have a clue what im doing because im a ninja)
        ...
        const newClassNames: string[] = ['inline-block font-normal leading-normal text-[#fff] text-center no-underline align-middle cursor-pointer select-none border-[1px] border-[solid] border-[transparent] px-[.75rem] py-[.375rem] text-[.9rem] rounded-[.25rem] [transition:color_.15s_ease-in-out,_background-color_.15s_ease-in-out,_border-color_.15s_ease-in-out,_box-shadow_.15s_ease-in-out]'];

        if (variant)
        {

            if (variant == 'primary')
                newClassNames.push('text-[#fff] bg-[#1e7295] border-[#1e7295] [box-shadow:inset_0_2px_#ffffff26,inset_0_-2px_#0000001a,0_1px_#0000001a] hover:text-[#fff] hover:bg-[#1a617f] hover:border-[#185b77]');

            if (variant == 'success')
                newClassNames.push('text-[#fff] bg-[#00800b] border-[#00800b] [box-shadow:inset_0_2px_#ffffff26,inset_0_-2px_#0000001a,0_1px_#0000001a] hover:text-[#fff] hover:bg-[#006d09] hover:border-[#006609]');

            if (variant == 'danger')
                newClassNames.push('text-[#fff] bg-[#a81a12] border-[#a81a12] [box-shadow:inset_0_2px_#ffffff26,inset_0_-2px_#0000001a,0_1px_#0000001a] hover:text-[#fff] hover:bg-[#8f160f] hover:border-[#86150e]');

            if (variant == 'warning')
                newClassNames.push('text-[#000] bg-[#ffc107] border-[#ffc107] [box-shadow:inset_0_2px_#ffffff26,inset_0_-2px_#0000001a,0_1px_#0000001a] hover:text-[#000] hover:bg-[#ffca2c] hover:border-[#ffc720]');
